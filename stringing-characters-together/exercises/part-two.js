...
//1) Use the .trim() method to remove the leading and trailing whitespace, 
...
//5) Just for fun, apply methods to ``dna`` and use 
//another template literal to print, 'taco cat'.
let tacoCat = dna.slice(4, 7).toLowerCase();

  console.log(`${tacoCat}o cat`);
